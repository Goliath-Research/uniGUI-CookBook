...
uses
  ...
  uniEdit, uniPanel, uniButton, uniImageList, uniBitBtn;
...
procedure TdLoginForm.edtPasswordKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = 13 then
    btnOkClick(Sender);
...
procedure TdLoginForm.edtUsernameKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = 13 then

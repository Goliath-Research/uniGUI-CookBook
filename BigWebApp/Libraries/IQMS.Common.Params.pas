...
destructor TIQMS_Params.Destroy;
begin
...
begin
  ...
  with RegistryValues[1] do
    EncryptedPassword := GetRegistryValue(fRootKey, Format(fKey, [WebIQDatabase]), fName, fDataType, '');
...
begin
  ...
  Result.Params.Database := WebIQDatabase;
...
begin
  ...
  begin
    ...
    Params.Add('Database=' + WebIQDatabase);

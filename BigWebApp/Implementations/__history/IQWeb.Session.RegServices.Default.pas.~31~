...
type
  ...
  public
    ...
    function  GetModuleByTreeCaption(aTreeCaption : string) : IIQModule;
...
procedure TIQModule.SetIconIndex(const Value: integer);
begin
  FIconIndex := Value;
end;
...
function TIQSessionRegistration.GetModuleByTreeCaption(aTreeCaption : string): IIQModule;
var
  aClassName : string;
begin
...
var
  Module : IIQModule;
begin
  Module := TIQModule.Create(aModuleClass, aModuleClass.ClassName, aSingleton);

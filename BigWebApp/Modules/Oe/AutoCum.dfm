object FrmAutoCum: TFrmAutoCum
  Left = 49
  Top = 156
  HelpContext = 1089659
  ClientHeight = 435
  ClientWidth = 685
  Caption = 'Automatic Customer Cumulative Reset '
  OnShow = UniFormShow
  ...
  object Panel1: TUniPanel
    ...
    object wwDate: TUniDBDateTimePicker
      ...
      Height = 21
      Hint = ''
      DateTime = 42680.000000000000000000
  ...
  object Panel3: TUniPanel
    ...
    object Panel4: TUniPanel
      ...
      TabOrder = 0
      Caption = ''
      inline IQSCust: TIQUniGridControl
        Left = 1
        Top = 20
        Width = 430
        Height = 112
    ...
    object Panel5: TUniPanel
      ...
      object Panel8: TUniPanel
        ...
        TabOrder = 0
        Caption = ''
        inline IQSOrds: TIQUniGridControl
          Left = 1
          Top = 20
          Width = 428
          Height = 121
      ...
      object Panel6: TUniPanel
        ...
        TabOrder = 1
        Caption = ''
        inline IQShip: TIQUniGridControl
          Left = 1
          Top = 20
          Width = 428
          Height = 109
  ...
  object QryCust: TFDQuery
    ...
    Left = 104
    Top = 91
    object QryCustCUSTNO: TStringField
      DisplayLabel = 'Cust#'
      DisplayWidth = 10
      FieldName = 'CUSTNO'
      Origin = 'CUSTNO'
    ...
    object QryCustADDR3: TStringField
  ...
  object SrcShip: TDataSource
    DataSet = QryShip
    Left = 88
    Top = 235
  end
  object QryShip: TFDQuery
    AfterScroll = QryShipAfterScroll
    MasterSource = SrcCust
    MasterFields = 'ID'
    Connection = UniMainModule.FDConnection1
    UpdateOptions.AssignedValues = [uvEDelete, uvEInsert, uvEUpdate]
    UpdateOptions.EnableDelete = False
    ...
    object QryShipATTN: TStringField
    ...
    object QryShipADDR1: TStringField
      DisplayLabel = 'Address1'
      DisplayWidth = 20
      FieldName = 'ADDR1'
      Origin = 's.ADDR1'
    ...
    object QryShipADDR2: TStringField
      DisplayLabel = 'Address2'
      DisplayWidth = 20
      FieldName = 'ADDR2'
      Origin = 's.ADDR2'
    ...
    object QryShipADDR3: TStringField
      DisplayLabel = 'Address3'
      DisplayWidth = 20
      FieldName = 'ADDR3'
      Origin = 's.ADDR3'
    ...
    object QryShipCITY: TStringField
      DisplayLabel = 'City'
      DisplayWidth = 20
      FieldName = 'CITY'
      Origin = 's.CITY'
    ...
    object QryShipSTATE: TStringField
      DisplayLabel = 'State'
      DisplayWidth = 5
      FieldName = 'STATE'
      Origin = 's.STATE'
    ...
    object QryShipCOUNTRY: TStringField
      DisplayLabel = 'Country'
      DisplayWidth = 15
      FieldName = 'COUNTRY'
      Origin = 's.COUNTRY'
    ...
    object QryShipZIP: TStringField
      DisplayLabel = 'Zip'
      DisplayWidth = 10
      FieldName = 'ZIP'
      Origin = 's.ZIP'
    ...
    object QryShipEPLANT_ID: TBCDField
    ...
    object QryShipNAME: TStringField
    ...
    object QryShipDESCRIP: TStringField
      DisplayLabel = 'Division Descrip.'
      DisplayWidth = 20
      FieldName = 'DESCRIP'
      Origin = 'd.descrip'
      Size = 50
    end
    object QryShipID: TBCDField
      DisplayWidth = 10
      FieldName = 'ID'
      Origin = 'ID'
      Visible = False
  ...
  object SrcOrds: TDataSource
    DataSet = QryOrd
    Left = 96
    Top = 371
  end
  object QryOrd: TFDQuery
    MasterSource = SrcShip
    MasterFields = 'ID'
    Connection = UniMainModule.FDConnection1
    UpdateOptions.AssignedValues = [uvEDelete, uvEInsert, uvEUpdate]
    UpdateOptions.EnableDelete = False
    ...
    object QryOrdDATE_TAKEN: TDateTimeField
      DisplayLabel = 'Date Taken'
      DisplayWidth = 18
      FieldName = 'DATE_TAKEN'
      Origin = 'DATE_TAKEN'
    end
    object QryOrdID: TBCDField
      DisplayWidth = 10
      FieldName = 'ID'
      Origin = 'ID'
      Visible = False
  ...
  object PopupMenu1: TUniPopupMenu
    Left = 560
    Top = 172
    object DeleteNode1: TUniMenuItem
      Caption = 'Delete Node'

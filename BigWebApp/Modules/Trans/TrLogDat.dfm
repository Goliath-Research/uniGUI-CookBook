inherited FrmTransLogBetweenDates: TFrmTransLogBetweenDates
  Caption = 'FrmTransLogBetweenDates'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited QryTransLog: TFDQuery
    SQL.Strings = (
      ...
      ' where'
      '       t.arinvt_id = :ID'
      '   and t.trans_date between :date_start and :date_end'
      '   and t.arinvt_id = a.id(+)'
      ''
      
        '   and (t.trans_in_out = '#39'IN'#39' and t.trans_type in ('#39'DISPOSITION'#39 +
        ')'
      '        or'
      
        '       (t.trans_in_out = '#39'IN'#39' and t.trans_type in ('#39'PO'#39') and a.s' +
        'tandard_id is not null)'
      '        or'
      
        '        t.trans_type in ('#39'MANUAL/ASSOCIATED'#39', '#39'MANUAL/BACKFLUSH'#39 +
        ', '#39'INVENTORY SCRAP'#39'))'
      '   and ( a.standard_ID is not NULL or a.id is null)'
      ''
      '   and'
      ''

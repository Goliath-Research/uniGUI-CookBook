object FrmAssyTrackCosting: TFrmAssyTrackCosting
  Left = 348
  Top = 215
  ClientHeight = 297
  ClientWidth = 461
  ...
  object QryMain: TFDQuery
    ...
    object QryMainSNDOP_ID: TBCDField
      FieldName = 'SNDOP_ID'
      Origin = 'IQ.C_ASSY1_PROC_COST.SNDOP_ID'
      Size = 0
    end
    object QryMainOPNO: TStringField
      FieldName = 'OPNO'
      Origin = 'IQ.SNDOP.OPNO'
      Size = 15
    end
    object QryMainOPDESC: TStringField
      FieldName = 'OPDESC'
  ...
  object IQAbout1: TIQWebAbout
    ModuleName = 'FrmAssyTrackCosting'
    Version = 'DEV.176554'
    ChangeListNumber = '$Change: 196063 $'
    BuildVersion = '176554'
    Left = 83
    Top = 228
  end

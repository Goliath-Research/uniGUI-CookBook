object FrmAssyTrackConfirmDelete: TFrmAssyTrackConfirmDelete
  Left = 438
  Top = 212
  ClientHeight = 133
  ClientWidth = 373
  ...
  object Panel3: TUniPanel
    ...
    object Label1: TUniLabel
      ...
      Height = 13
      Hint = ''
      Caption = 'About to remove workorder from Assembly Track.'
      Align = alTop
      Anchors = [akLeft, akTop, akRight]
      TabOrder = 1
    end
  ...
  object Panel4: TUniPanel
    ...
    object chkDelete: TUniCheckBox
      ...
      Height = 17
      Hint = ''
      Caption = 'Delete workorder from the system'
      TabOrder = 0
    end
  end
  ...
  object SR: TIQWebSecurityRegister
    SecurityItems.Strings = (
      'btnOK'
      'chkDelete')
    SecurityCode = 'FRMASSYTRACKCONFIRMDELETE'
    Left = 118
    Top = 94
  end
end

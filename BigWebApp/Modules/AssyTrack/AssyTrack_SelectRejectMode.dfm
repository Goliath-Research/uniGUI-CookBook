object FrmAssyTrackSelectRejectMode: TFrmAssyTrackSelectRejectMode
  Left = 8
  Top = 8
  ClientHeight = 154
  ClientWidth = 302
  Caption = 'Select Reject Mode'
  ...
  object sbtnClearRejectCode: TUniSpeedButton
    ...
    ParentColor = False
    Color = clWindow
    OnClick = sbtnClearRejectCodeClick
  end
  object rbtnComponents: TUniRadioButton
    Left = 13
    Top = 12
    Width = 137
    Height = 17
    Hint = ''
    Caption = 'Reject Components'
    TabOrder = 0
    OnClick = EnableControls
  end
  object rbtnMfgParts: TUniRadioButton
    Left = 13
    Top = 39
    Width = 113
    Height = 17
    Hint = ''
    Caption = 'Reject Mfg Parts'
    TabOrder = 1
    OnClick = EnableControls
  end

object FrmBookPostings: TFrmBookPostings
  Left = 59
  Top = 175
  ClientHeight = 286
  ClientWidth = 522
  Caption = 'Book posting history'
  ...
  object QryPost: TFDQuery
    AfterInsert = QryPostAfterInsert
    BeforeEdit = QryPostBeforeEdit
    BeforePost = QryPostBeforePost
    AfterPost = QryPostAfterPost
    AfterDelete = QryPostAfterPost
    Connection = UniMainModule.FDConnection1
    UpdateOptions.UpdateTableName = ' FA_DEPR_POSTING'
    ...
    object QryPostPOST_DATE: TDateTimeField
      DisplayLabel = 'Post Date'
      DisplayWidth = 18
      FieldName = 'POST_DATE'
      Origin = 'f.POST_DATE'
    end
    object QryPostAMOUNT: TBCDField
      DisplayLabel = 'Amount'
      DisplayWidth = 10
      FieldName = 'AMOUNT'
      Origin = 'f.AMOUNT'
    ...
    object QryPostBEG_BALANCE: TStringField
      DisplayLabel = 'Beg. balance'
      DisplayWidth = 1
      FieldName = 'BEG_BALANCE'
      Origin = 'f.BEG_BALANCE'
      FixedChar = True
      Size = 1
    end
    object QryPostPERIOD: TBCDField
    ...
    object QryPostYEAR: TStringField
    ...
    object QryPostFINALIZED_DATE: TDateTimeField
      DisplayLabel = 'Finalized Date'
      DisplayWidth = 18
      FieldName = 'FINALIZED_DATE'
    end
    object QryPostID: TBCDField
      DisplayWidth = 10
      FieldName = 'ID'
    ...
    object QryPostGLPERIODS_ID: TBCDField
      DisplayWidth = 10
      FieldName = 'GLPERIODS_ID'
      Visible = False
      Size = 0
    end
    object QryPostGLBATCHID_ID: TBCDField
      FieldName = 'GLBATCHID_ID'
      Origin = 'f.glbatchid_id'
      Visible = False
      Size = 0
    end
    object QryPostFA_BOOK_ID: TBCDField
  ...
  object IQAbout1: TIQWebAbout
    ModuleName = 'Book posting history'
    Version = 'DEV.176554'
    ChangeListNumber = '$Change: 197427 $'
    BuildVersion = '176554'
    Left = 296
    Top = 94
  end
  object UpdateSQL1: TFDUpdateSQL
    Connection = UniMainModule.FDConnection1
    InsertSQL.Strings = (
      'insert into FA_DEPR_POSTING'
      '  (ID, FA_BOOK_ID, POST_DATE, GLPERIODS_ID, AMOUNT, BEG_BALANCE)'
      'values'
      
        '  (:ID, :FA_BOOK_ID, :POST_DATE, :GLPERIODS_ID, :AMOUNT, :BEG_BA' +
        'LANCE)')
    ModifySQL.Strings = (
      'update FA_DEPR_POSTING'
      'set'
      '  ID = :ID,'
      '  FA_BOOK_ID = :FA_BOOK_ID,'
      '  POST_DATE = :POST_DATE,'

object FrmQCDocTeam: TFrmQCDocTeam
  Left = 186
  Top = 149
  HelpContext = 10773
  ClientHeight = 382
  ClientWidth = 613
  Caption = 'Assign Team  Members to Library'
  OnShow = UniFormShow
  ...
  object wwTeam: TUniDBLookupComboBox
    Left = 219
    Top = 105
    Width = 149
    Height = 21
    ...
    ListField = 'NAME'
    ListSource = SrcTeamMember
    KeyField = 'ID'
    ListFieldIndex = 0
    TabOrder = 1
    Color = clWindow
  end
  object wwAuthRev: TUniDBComboBox
    Left = 219
    Top = 144
    Width = 149
    Height = 21
    ...
    Items.Strings = (
      'Authorize'#9'Authorize'
      'Review'#9'Review'
      'Access Only'#9'Access')
    TabOrder = 2
  end
  ...
  object QryTeamMember: TFDQuery
    ...
    SQL.Strings = (
      'select id, name, title from TEAM_MEMBER'
      'where used_doc = '#39'Y'#39
      'order by name')
    Left = 176
    Top = 148
    object QryTeamMemberNAME: TStringField
    ...
    object QryTeamMemberTITLE: TStringField
      DisplayLabel = 'Member Title'
      DisplayWidth = 20
      FieldName = 'TITLE'
    ...
    object QryTeamMemberID: TBCDField
      DisplayWidth = 10
      FieldName = 'ID'
  ...
  object IQAbout1: TIQWebAbout
    ModuleName = 'Assign Library to Team  Member'
    Version = 'DEV.176554'
    ChangeListNumber = '$Change: 192748 $'
    BuildVersion = '176554'
    Left = 352
    Top = 243
  end
  object TblDocTeam: TFDQuery
    BeforeOpen = TblDocTeamBeforeOpen
    BeforePost = TblDocTeamBeforePost
    AfterPost = ApplyUpdate
    AfterDelete = ApplyUpdate
    OnNewRecord = TblDocTeamNewRecord
    CachedUpdates = True
    Connection = UniMainModule.FDConnection1
    UpdateObject = UpdateSQLTeamDoc
    SQL.Strings = (
      'select t.id,'
      '       t.doc_library_id,'
      '       t.team_member_id,'
      ...
      '  from doc_team t,'
      '       team_member m'
      ' where t.doc_library_id = :doc_library_id'
      '   and t.team_member_id = m.id(+)'
      '')
    Left = 16
    Top = 160
    ParamData = <
    ...
    object TblDocTeamSEQ: TBCDField
      DisplayLabel = ' # '
      DisplayWidth = 6
      FieldName = 'SEQ'
      Origin = 't.seq'
    ...
    object TblDocTeamTYPE: TStringField
      DisplayLabel = 'Type'
      DisplayWidth = 20
      FieldName = 'TYPE'
      Origin = 't.type'
    ...
    object TblDocTeamNAME: TStringField
      DisplayLabel = 'Member Name'
      DisplayWidth = 50
      FieldName = 'NAME'
      Origin = 'm.name'
    ...
    object TblDocTeamTEAM_MEMBER_ID: TBCDField
      DisplayLabel = 'Member Name'
      DisplayWidth = 10
    ...
    object TblDocTeamID: TBCDField
      DisplayWidth = 10
      FieldName = 'ID'
      Visible = False
      Size = 0
    end
    object TblDocTeamDOC_LIBRARY_ID: TBCDField
      DisplayWidth = 10
      FieldName = 'DOC_LIBRARY_ID'
      Required = True
      Visible = False
      Size = 0
    end
  end
  object UpdateSQLTeamDoc: TFDUpdateSQL
    Connection = UniMainModule.FDConnection1
    InsertSQL.Strings = (
      'insert into doc_team'
      '  (ID, DOC_LIBRARY_ID, TEAM_MEMBER_ID, SEQ, TYPE)'
      'values'
      '  (:ID, :DOC_LIBRARY_ID, :TEAM_MEMBER_ID, :SEQ, :TYPE)')
    ModifySQL.Strings = (
      'update doc_team'
      ...
      '  ID = :OLD_ID')
    DeleteSQL.Strings = (
      'delete from doc_team'
      'where'
      '  ID = :OLD_ID')
    Left = 48
    Top = 246
  end
  object SrcTeamMember: TDataSource

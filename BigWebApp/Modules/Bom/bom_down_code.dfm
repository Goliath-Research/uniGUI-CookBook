object FrmBomDownTimeCode: TFrmBomDownTimeCode
  Left = 214
  Top = 290
  ClientHeight = 256
  ClientWidth = 356
  Caption = 'Downtime Codes'
  OnShow = UniFormShow
  ...
  object wwQuery1: TFDQuery
    ...
    UpdateObject = UpdateSQLDowmTimeCode
    SQL.Strings = (
      'select id,'
      '       standard_id,'
      '       down_code,'
      '       seq'
      '  from standard_down_code'
    ...
    object wwQuery1SEQ: TBCDField
      ...
      DisplayWidth = 10
      FieldName = 'SEQ'
      Origin = 'IQ.STANDARD_DOWN_CODE.SEQ'
      Size = 0
    end
    object wwQuery1DOWN_CODE: TStringField
      DisplayLabel = 'Down Code'
      DisplayWidth = 13
      FieldName = 'DOWN_CODE'
      Origin = 'IQ.STANDARD_DOWN_CODE.DOWN_CODE'
      FixedChar = True
      Size = 5
    end
    ...
    object wwQuery1ID: TBCDField
      DisplayWidth = 10
      FieldName = 'ID'
      Origin = 'IQ.STANDARD_DOWN_CODE.ID'
    ...
    object wwQuery1STANDARD_ID: TBCDField
      ...
      Origin = 'IQ.STANDARD_DOWN_CODE.STANDARD_ID'
      Visible = False
      Size = 0
    end
  end
  object UpdateSQLDowmTimeCode: TFDUpdateSQL
    Connection = UniMainModule.FDConnection1
    InsertSQL.Strings = (
      'insert into standard_down_code'
      '  (ID, STANDARD_ID, DOWN_CODE, SEQ)'
      'values'
      '  (:ID, :STANDARD_ID, :DOWN_CODE, :SEQ)')
    ModifySQL.Strings = (
      'update standard_down_code'
      'set'
      '  ID = :ID,'
      ...
      '  ID = :OLD_ID')
    DeleteSQL.Strings = (
      'delete from standard_down_code'
      'where'
      '  ID = :OLD_ID')
    Left = 56
    Top = 146
  ...
  object SR: TIQWebSecurityRegister
    SecurityItems.Strings = (
      ...
      'sbtnMoveUp'
      'sbtnMoveDown')
    SecurityCode = 'FRMBOMDOWNTIMECODE'
    Left = 160
    Top = 96
  end
end

object FrmUpdateSalesPersonCheck: TFrmUpdateSalesPersonCheck
  Left = 486
  Top = 301
  ClientHeight = 344
  ClientWidth = 584
    ...
    object PnlActions: TUniPanel
      ...
      object rgActions: TUniRadioGroup
        ...
        Items.Strings = (
            ...
            'Replace salesperson on Sales Orders  (you will be prompted for n' +
            'ew salesperson)'
          'Clear salesperson on Sales Orders'
    ...
    object PnlHeader: TUniPanel
      ...
      object PnlPrompt: TUniPanel
        ...
        object lblPrompt: TUniLabel
          ...
          Hint = ''
          Caption = 
            'One or more Sales Orders have been assigned to this salesperson.' +
  ...
  object QryOrders: TFDQuery
    ...
    SQL.Strings = (
      ...
      '         b.date_taken AS date_taken,'
      '         d.attn AS bill_to_attn,'
      '         e.attn AS ship_to_attn,'
      '         f.descrip AS freight'
      
        '    FROM ord_detail_commissions a, orders b, ord_detail c, bill_' +
        'to d, ship_to e,'
      '         freight f'
      
        '   WHERE (:SALESPEOPLE_ID = 0 OR a.salespeople_id = :SALESPEOPLE' +
        '_ID) AND'
      
        '         (:COMMISSIONS_ID = 0 OR a.commissions_id = :COMMISSIONS' +
        '_ID) AND'
      '         c.id = a.ord_detail_id AND'
      '         b.id = c.orders_id AND'
      '         (:ARCUSTO_ID = 0 OR b.arcusto_id = :ARCUSTO_ID) AND'
      '         (:SHIP_TO_ID = 0 OR b.ship_to_id = :SHIP_TO_ID) AND'
      '         d.id(+) = b.bill_to_id AND'
      '         e.id(+) = b.ship_to_id AND'
      '         f.id(+) = b.freight_id'
      'ORDER BY b.id')
    Left = 104
    Top = 184
  ...
  object PkSalesPerson: TIQWebHpick
    BeforeOpen = DoBeforeOpen
    Connection = UniMainModule.FDConnection1
    SQL.Strings = (
      'SELECT a.id AS id,'
      ...
      '  FROM salespeople a'
      ' WHERE a.id <> :SALESPEOPLE_ID AND'
      '       NVL(a.inactive, '#39'N'#39') <> '#39'Y'#39
      '')
    ...
    object PkSalesPersonID: TBCDField
      FieldName = 'ID'
      Origin = 'a.id'
      Visible = False
      Size = 0
    end
    object PkSalesPersonFIRST_NAME: TStringField
      DisplayLabel = 'First Name'
      FieldName = 'FIRST_NAME'
      Origin = 'a.first_name'
      Size = 30
    end
    object PkSalesPersonMIDDLE_NAME: TStringField
      DisplayLabel = 'Middle Name'
      FieldName = 'MIDDLE_NAME'
      Origin = 'a.middle_name'
      Size = 30
    end
    object PkSalesPersonLAST_NAME: TStringField

object FrmImporters: TFrmImporters
  Left = 298
  Top = 158
  HelpContext = 1220827
  ClientHeight = 266
    ...
    object PC: TUniPageControl
      ...
      object TabGrid: TUniTabSheet
        ...
        object Grid: TIQUniGridControl
          ...
          IQComponents.Grid.DataSource = SrcImporter
          ...
          IQComponents.Navigator.DataSource = SrcImporter
  ...
  object IQAbout1: TIQWebAbout
    ModuleName = 'Importers'
    Version = 'DEV.176554'
    ChangeListNumber = '$Change: 196870 $'
    BuildVersion = '176554'
    Left = 168
  end
  object SrcImporter: TDataSource
    DataSet = TblImporter
    OnDataChange = SrcImporterDataChange
    Left = 199
  end
  object TblImporter: TFDTable
    BeforeOpen = TblImporterBeforeOpen
    BeforePost = TblImporterBeforePost
    BeforeDelete = TblImporterBeforeDelete
    OnNewRecord = TblImporterNewRecord
    Filtered = True
    IndexFieldNames = 'ID'
    Connection = UniMainModule.FDConnection1
    ...
    object TblImporterEPlant_Name: TStringField

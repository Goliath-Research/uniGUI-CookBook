object FrmHREventTypes: TFrmHREventTypes
  Left = 421
  Top = 276
  ClientHeight = 284
  ClientWidth = 434
  ...
  object TblEventType: TFDTable
    BeforeOpen = TblEventTypeBeforeOpen
    BeforeDelete = TblEventTypeBeforeDelete
    OnNewRecord = TblEventTypeNewRecord
    Connection = UniMainModule.FDConnection1
    UpdateOptions.UpdateTableName = 'HR_EVENT_TYPE'
    TableName = 'HR_EVENT_TYPE'
    Left = 72
    Top = 104
    object TblEventTypeNAME: TStringField
      DisplayLabel = 'Name'
      DisplayWidth = 17
      FieldName = 'NAME'
      Size = 35
    end
    object TblEventTypeDESCRIPTION: TStringField
      DisplayLabel = 'Description'
      DisplayWidth = 25
      FieldName = 'DESCRIPTION'
      Size = 255
    end
    object TblEventTypeLabelColor: TStringField
      DisplayLabel = 'Color'
      DisplayWidth = 10
    ...
    object TblEventTypeEPlant: TStringField
      DisplayWidth = 18
      FieldKind = fkLookup
      FieldName = 'EPlant'
      LookupDataSet = QryEPlantLookup
      LookupKeyFields = 'ID'
    ...
    object TblEventTypeLABEL_COLOR: TBCDField
      DisplayLabel = 'Color'
      DisplayWidth = 10
    ...
    object TblEventTypeID: TBCDField
      DisplayWidth = 10
      FieldName = 'ID'
    ...
    object TblEventTypeEPLANT_ID: TBCDField
      FieldName = 'EPLANT_ID'
      Visible = False
      Size = 0
    end
  end
  object QryEPlantLookup: TFDQuery
    Connection = UniMainModule.FDConnection1
    ...
    Left = 80
    Top = 110
    object QryEPlantLookupID: TBCDField
      FieldName = 'ID'
      Origin = 'IQ.EPLANT.ID'
      Size = 0
    end
    object QryEPlantLookupNAME: TStringField
      FieldName = 'NAME'

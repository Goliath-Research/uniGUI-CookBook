object FrmRecvDays: TFrmRecvDays
  Left = 93
  Top = 212
  ClientHeight = 296
  ClientWidth = 455
  ...
  object wwDBComboDlgRecvDays: TUniEdit
    Left = 64
    Top = 123
    Width = 121
    Height = 21
  ...
  object wwDBComboDlgOrigin: TUniEdit
    Left = 64
    Top = 155
    Width = 121
    Height = 21
  ...
  object SrcRecvDays: TDataSource
    DataSet = TblRecvDays
    Left = 320
    Top = 40
  end
  object TblRecvDays: TFDTable
    BeforePost = TblRecvDaysBeforePost
    OnCalcFields = TblRecvDaysCalcFields
    IndexFieldNames = 'ID'
    Connection = UniMainModule.FDConnection1
    UpdateOptions.UpdateTableName = 'RECV_DAYS'
    UpdateOptions.KeyFields = 'ID'
    TableName = 'RECV_DAYS'
    Left = 288
    Top = 40
    object TblRecvDaysRecvDaysCount: TFloatField
      DisplayLabel = 'Receiving Days'
      DisplayWidth = 12
      FieldKind = fkCalculated
      FieldName = 'RecvDaysCount'
      Calculated = True
    end
    object TblRecvDaysSource: TStringField
      DisplayWidth = 20
      FieldKind = fkCalculated
      FieldName = 'Source'
      Calculated = True
    end
    object TblRecvDaysOrigin: TStringField
      DisplayWidth = 20
      FieldKind = fkCalculated
      FieldName = 'Origin'
      Calculated = True
    end
    object TblRecvDaysUSE_VENDOR_RECV_DAYS: TStringField
      DisplayLabel = 'Use Vendor ~Receiving Days'
      DisplayWidth = 14
      FieldName = 'USE_VENDOR_RECV_DAYS'
      Size = 1
    end
    object TblRecvDaysID: TBCDField
      DisplayWidth = 10
      FieldName = 'ID'
    ...
    object TblRecvDaysEPLANT_ID: TBCDField
      DisplayWidth = 10
      FieldName = 'EPLANT_ID'
      Visible = False
      Size = 0
    end
    object TblRecvDaysSUN_SHIP: TStringField
      DisplayWidth = 1
      FieldName = 'SUN_SHIP'
      Visible = False
      FixedChar = True
    ...
    object TblRecvDaysMON_SHIP: TStringField
      DisplayWidth = 1
      FieldName = 'MON_SHIP'
      Visible = False
      FixedChar = True
    ...
    object TblRecvDaysTUE_SHIP: TStringField
      DisplayWidth = 1
      FieldName = 'TUE_SHIP'
      Visible = False
      FixedChar = True
    ...
    object TblRecvDaysWED_SHIP: TStringField
      DisplayWidth = 1
      FieldName = 'WED_SHIP'
      Visible = False
      FixedChar = True
    ...
    object TblRecvDaysTHU_SHIP: TStringField
      DisplayWidth = 1
      FieldName = 'THU_SHIP'
      Visible = False
      FixedChar = True
    ...
    object TblRecvDaysFRI_SHIP: TStringField
      DisplayWidth = 1
      FieldName = 'FRI_SHIP'
      Visible = False
      FixedChar = True
    ...
    object TblRecvDaysSAT_SHIP: TStringField
      DisplayWidth = 1
      FieldName = 'SAT_SHIP'
      Visible = False
      FixedChar = True

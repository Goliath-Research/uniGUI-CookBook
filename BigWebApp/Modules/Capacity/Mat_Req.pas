...
begin
  DoShowPastDuePOs( QryUniqueItemsARINVT_ID.asFloat, DateEnd ); {PastDuPo.pas}
end;
...
begin
  TFrmSalesOrderDRP.CreateModaless( QryV_Day_Mat_Req_DtlARINVT_ID.asFloat, QryV_Day_Mat_Req_DtlPROD_DATE.asDateTime ); {OrdersDRP.pas}
end;

...
begin
  ...
  begin
    // if Highlight then Font else Brush
    // At this point we are assigning colors to a set of rows...
    // The JS code on the client will take care of the highlight
    Attribs.Font.Color := clAqua;

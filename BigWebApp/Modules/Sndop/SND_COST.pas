...
begin
  ...
  nLabor     := StdOpLbr( FSndID, cSndOpTable, cLBR_RATEtable );
  nOverHead  := StdOpOH ( FSndID, cSndOpTable );
  nMaterials := StdOpMat( FSndID, FQty );
  nOutSourced:= StdOpOut( FSndID, FQty, cSndOpTable, cBreakTable, cBreakIDname );

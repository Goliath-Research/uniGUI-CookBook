unit IQMS.WebComponents.MenuToActionListEditor;
...
type
  TIQMenuToActionListEditor = class(TComponentEditor)
  private
...
procedure TIQMenuToActionListEditor.DisplayUnassignedActionsList;
var
  i: integer;
  sl: TStringList;
begin
...
procedure TIQMenuToActionListEditor.ExecuteVerb(Index: Integer);
begin
  case Index of
...
function TIQMenuToActionListEditor.GetVerbCount: Integer;
begin
  Result := 2;
end;

function TIQMenuToActionListEditor.GetVerb(Index: Integer): string;
begin
  case Index of
...
procedure TIQMenuToActionListEditor.ShowActionListEditor;
begin

object IQUniGridControl: TIQUniGridControl
  Left = 0
  Top = 0
  Width = 651
  Height = 520
  ...
  object PageControl: TUniPageControl
    ...
    object GridTab: TUniTabSheet
      ...
      object GridEditorsPanel: TUniHiddenPanel
        Left = 434
        Top = 29
        Width = 209
        Height = 434
      ...
      object GridToolBar: TUniToolBar
        Left = 0
        Top = 0
        Width = 643
        Height = 29
        ...
        ParentColor = False
        Color = clBtnFace
        object btnCaseSensitive: TUniToolButton
          Left = 0
          Top = 0
          Hint = 'Case Sensitive'
          ShowHint = True
        ...
        object btnExactMatch: TUniToolButton
          Left = 23
          Top = 0
          Hint = 'Exact Match'
          ShowHint = True
        ...
        object btnSearch: TUniToolButton
          Left = 92
          Top = 0
          Hint = ''
          ShowHint = True
  ...
  object TopToolBar: TUniToolBar
    ...
    object DesignBtn: TUniToolButton
      Left = 62
      Top = 0
      Hint = 'Design Mode'
      ShowHint = True
    ...
    object UniToolButton6: TUniToolButton
      ...
      Layout = 'fit'
      TabOrder = 8
      object ActionToolBar: TUniToolBar
        Left = 0
        Top = 0
        Width = 292
        Height = 22

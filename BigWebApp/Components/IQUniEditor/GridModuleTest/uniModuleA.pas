...
uses
  ...
  IQMS.WebComponents.DataControllerList, System.ImageList, Vcl.ImgList,
...
uses
  UniGUIVars, uniGUIMainModule, MainModule, IQUniEditor, IQModuleFormDesigner;
...
initialization
  ...
  IQRegisterClass(RegisteredDataModules, 'DataModuleA', TDataModuleA);

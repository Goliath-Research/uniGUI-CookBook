...
procedure DoDocDescrip(ADocClass : string; ADataSet : TDataSet);
...
begin
  ...
  AParentTableName := TIQWebDocs(uniGUIApplication.UniApplication).Source;
...
begin
  if not IQPickAndReplace(DocsLink.FieldByName('IQ_DOCS_ID'), PkIQ_Docs, 'ID') then

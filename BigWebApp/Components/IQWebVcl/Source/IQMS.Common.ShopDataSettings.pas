unit IQMS.Common.ShopDataSettings;
...
uses
    IQMS.Common.DataLib, IQMS.Common.StringUtils;
...
begin
//  Result := iqregset.ReadSetting_Float2(FLocalMachineSettingsPath, cDefaultWorkCenterID, 0);
end;

function TShopDataSettings.GetAllowNavWorkCenters: Boolean;
begin
//  Result := iqregset.ReadSetting_Bool2(FLocalMachineSettingsPath, cAllowNavWorkCenter, TRUE);
end;

function TShopDataSettings.GetConfig(const ASetting: String;
  ADefault: String): String;
begin
//  Result := iqregset.ReadSetting_String(FLocalMachineSettingsPath, ASetting, ADefault);
end;

function TShopDataSettings.GetConfig(const ASetting: String;
  ADefault: Integer): Integer;
begin
//  Result := iqregset.ReadSetting_Int(FLocalMachineSettingsPath, ASetting, ADefault);
end;
...
//  Result := iqregset.ReadSetting_Bool2(FLocalMachineSettingsPath, cHideMouse, ADefault);
end;

function TShopDataSettings.GetLaunchLastFormOnStartup: Boolean;
begin
  // 02/14/2014
//  Result := iqregset.ReadSetting_Bool2(FLocalMachineSettingsPath, cLaunchLastFromOnStartup, FALSE);
end;

function TShopDataSettings.GetPromptForBadgeNumber: Boolean;
begin
  // 05/15/2014
//  Result := iqregset.ReadSetting_Bool2(FLocalMachineSettingsPath, cPromptForBadgeNumber, FALSE);
end;

function TShopDataSettings.GetQuickInspectionSource: String;
begin
//  Result := iqregset.ReadSetting_String(FLocalMachineSettingsPath, cQuickInspectionSource, '');
end;

function TShopDataSettings.GetRTLblsShowGridWhenMultiplePartsRunning: Boolean;
begin
//  Result := iqregset.ReadSetting_Bool2(FLocalMachineSettingsPath, cRTLblsShowGridWhenMultiplePartsRunning, FALSE);
end;
...
begin
//  Result := iqregset.ReadSetting_Bool2(FLocalMachineSettingsPath, cShowTimeClock, TRUE);
end;

function TShopDataSettings.GetTimeClockType: Integer;
begin
//  Result := iqregset.ReadSetting_Int2(FLocalMachineSettingsPath, cTimeClockType, 0);
end;

procedure TShopDataSettings.SetADefaultWorkCenterID(const Value: Real);
begin
//  iqregset.WriteSetting_Float2(FLocalMachineSettingsPath, cDefaultWorkCenterID, Value);
end;

procedure TShopDataSettings.SetAllowNavWorkCenters(const Value: Boolean);
begin
//  iqregset.WriteSetting_Bool2(FLocalMachineSettingsPath, cAllowNavWorkCenter, Value);
end;

procedure TShopDataSettings.SetConfig(const ASetting, AValue: String);
begin
//  iqregset.WriteSetting_String(FLocalMachineSettingsPath, ASetting, AValue);
end;

procedure TShopDataSettings.SetConfig(const ASetting: String;
  AValue: Integer);
begin
//  iqregset.WriteSetting_Int(FLocalMachineSettingsPath, ASetting, AValue);
end;
...
begin
//  iqregset.WriteSetting_Bool2(FLocalMachineSettingsPath, cHideMouse, Value);
end;

procedure TShopDataSettings.SetLaunchLastFormOnStartup(const Value: Boolean);
begin
  // 02/14/2014
//  iqregset.WriteSetting_Bool2(FLocalMachineSettingsPath, cLaunchLastFromOnStartup, Value);
end;

procedure TShopDataSettings.SetPromptForBadgeNumber(const Value: Boolean);
begin
  // 05/15/2014
//  iqregset.WriteSetting_Bool2(FLocalMachineSettingsPath, cPromptForBadgeNumber, Value);
end;

procedure TShopDataSettings.SetQuickInspectionSource(const Value: String);
begin
//  iqregset.WriteSetting_String(FLocalMachineSettingsPath,
...
procedure TShopDataSettings.SetRTLblsShowGridWhenMultiplePartsRunning(
  const Value: Boolean);
begin
//  iqregset.WriteSetting_Bool2(FLocalMachineSettingsPath, cRTLblsShowGridWhenMultiplePartsRunning, Value);
end;
...
begin
//  iqregset.WriteSetting_Bool2(FLocalMachineSettingsPath, cShowTimeClock, Value);
end;

procedure TShopDataSettings.SetTimeClockType(const Value: Integer);
begin
//  iqregset.WriteSetting_Int2(FLocalMachineSettingsPath, cTimeClockType, Value);
end;
...
//  Result:= iqregset.ReadSetting_Bool(FCurrentUserSettingsPath, cDispoOnPalletComplete, FALSE);
end;
...
(*  ExecuteCommandFmt('begin iqsys3_settings.set_pltbldr_disp_plt_complete( ''%s'' ); end; ',
                      [ IQString.BoolToYN( Value ) ]);
*)
//  iqregset.WriteSetting_Bool(FCurrentUserSettingsPath, cDispoOnPalletComplete, Value);
end;
...
begin
//  Result := iqregset.ReadSetting_Bool(FCurrentUserSettingsPath, cPromptPalletComplete, TRUE);
end;
...
//  Result := iqregset.ReadSetting_Bool(FCurrentUserSettingsPath, cPromptPalletQty, FALSE);
end;
...
(*  ExecuteCommandFmt('begin iqsys3_settings.set_pltbldr_prmpt_pallet_qty( ''%s'' ); end; ',
                      [ IQString.BoolToYN( Value ) ]);
*)
//  iqregset.WriteSetting_Bool(FCurrentUserSettingsPath, cPromptPalletQty, Value);
end;

procedure TWCPalletBuilderSettings.SetPromptPrintCompletePallet(
  const Value: Boolean);
begin
//  iqregset.WriteSetting_Bool(FCurrentUserSettingsPath, cPromptPalletComplete, Value);
end;

function TWCPalletBuilderSettings.GetWarnOnNonConformScan: Boolean;
begin
//  Result:= iqregset.ReadSetting_Bool(FCurrentUserSettingsPath, cWarnNCScan, TRUE);
end;

procedure TWCPalletBuilderSettings.SetWarnOnNonConformScan(
  const Value: Boolean);
begin
//  iqregset.WriteSetting_Bool(FCurrentUserSettingsPath, cWarnNCScan, Value);
end;
